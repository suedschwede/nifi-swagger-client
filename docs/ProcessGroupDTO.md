...
**flowfileOutboundPolicy** | [**FlowfileOutboundPolicyEnum**](#FlowfileOutboundPolicyEnum) | The Oubound Policy that is used for determining how FlowFiles should be transferred out of the Process Group. |  [optional]
